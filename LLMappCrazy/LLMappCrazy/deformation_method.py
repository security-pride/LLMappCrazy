...
class DeformationMethod:
    ...
    def appname_deformation(self):
        ...
        if (self.ori_name in self.variant_dic.keys()) :  # self.add_case_substitution()
            self.variant_dic.pop(self.ori_name)
    ...
    def add_case_substitution(self):
        """Generate case substitutions for the original name, handling both single and multi-word names and removing duplicates."""
        ...
        if len(words) == 1:
            ...
            # 添加变体：全小写、全大写和首字母大写
            self.variant_dic[single_word_lower] = 'case_substitution'
            self.variant_dic[single_word_upper] = 'case_substitution'
            self.variant_dic[single_word_title] = 'case_substitution'
        ...
        # 如果是多个单词
            ...
            self.variant_dic[multi_word_lower] = 'case_substitution'
            self.variant_dic[multi_word_upper] = 'case_substitution'
            self.variant_dic[multi_word_title] = 'case_substitution'
